...
BEGIN
	...
	SELECT '>> TRUNCATE Table: silver.erp_cust_az12' AS message;
	TRUNCATE TABLE silver.epr_cust_az12;
	SELECT '>> INSERT INTO TABLE Table: silver.erp_cust_az12' AS message;
	...
	SELECT '>> TRUNCATE Table: silver.erp_loc_a101' AS message;
	TRUNCATE TABLE silver.erp_loc_a101;
	SELECT '>> INSERT INTO TABLE Table: silver.erp_loc_a101' AS message;
	...
	SELECT '>> TRUNCATE Table: silver.erp_px_cat_g1v2' AS message;
	TRUNCATE TABLE silver.erp_px_cat_g1v2;
	SELECT '>> INSERT INTO TABLE Table: silver.erp_px_cat_g1v2' AS message;
